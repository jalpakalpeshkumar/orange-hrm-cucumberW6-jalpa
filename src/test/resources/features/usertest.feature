Feature: User Test
  ...
  Scenario: Admin should add user successfully
    ...
    And I enter User Name "jenny1234"
    And I select Status as Disable
    And I enter Password "jenny@123" in create user
    And I enter Confirm Password "jenny@123" in create User
  ...
  Scenario: User created successfully and verify it
    ...
    And I click on Admin tab
    And I should see the System Users text
    And I enter user name "jenny1234" in system users page
    And I select user role as Admin in system users page
    And I select status as disable in system users page
    And I click on search button
    Then I should verify the user name "jenny1234" in result list
  ...
  Scenario: Admin should delete the user successfully
    ...
    And I select status as disable in system users page
    And I click on search button
    And I should verify the user name "jenny1234" in result list
